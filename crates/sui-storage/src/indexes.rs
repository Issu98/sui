...
impl IndexStore {
    ...
    pub fn index_tx(
        ...
        let coin_delete_keys = object_index_changes
            ...
            .filter_map(|(owner, obj_id)| {
                ...
                let coin_type_tag = input_coins.get(obj_id)?
                    // panic!(
                    //     "input_coins does not contain object_id: {:?}, input_coins: {:?}, deleted_owners: {:?}, tx_digest: {:?}",
                    //     obj_id, input_coins, object_index_changes.deleted_owners, digest
                    // )
        ...
        .filter_map(|((owner, obj_id), obj_info)| {
            ...
            // .unwrap_or_else(|| {
            //     panic!(
            //         "written_coins does not contain object_id: {:?}, written_coins: {:?}, new_owners: {:?}, tx_digest: {:?}",
            //         obj_id, written_coins, object_index_changes.new_owners, digest
            //     )
            // });
